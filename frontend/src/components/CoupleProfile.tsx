    ...
    >
      <div className="relative z-10 container mx-auto max-w-6xl px-6">
        <div className="mb-24 space-y-6 text-center md:mb-32">
          ...
          <span className="text-accentDark dark:text-accent font-serif text-xl sm:text-2xl italic">
            {config.text.opening.salam}
          </span>
          <h2 className="font-serif text-4xl sm:text-6xl md:text-7xl tracking-tight text-slate-900 italic dark:text-white">
            The Happy Couple
          </h2>
          <div className="bg-accent/30 mx-auto h-[1px] w-20"></div>
          <p className="mx-auto max-w-3xl font-serif text-lg sm:text-xl md:text-2xl leading-relaxed font-light text-balance text-slate-600 italic dark:text-slate-300">
            {config.text.quote.ar_rum}
          </p>
          <p className="font-sans text-[10px] sm:text-[11px] font-bold tracking-[0.3em] text-slate-400 uppercase">
        ...
        <div className="grid items-start gap-20 md:grid-cols-2 md:gap-24">
          <div className="group flex flex-col items-center space-y-10 text-center md:items-end md:text-right">
            ...
            <div className="space-y-4 md:space-y-6">
              <h3 className="font-script text-5xl sm:text-7xl md:text-8xl text-slate-900 py-1 dark:text-white drop-shadow-sm">
                {groom.fullName}
              </h3>
              <p className="font-sans ml-auto max-w-xs text-[11px] font-medium tracking-[0.2em] text-balance text-slate-500 uppercase md:max-w-sm md:text-[13px] dark:text-slate-400">
                {groom.parents}
              </p>
              <a
                ...
                className="font-sans dark:text-accent/50 hover:text-accentDark inline-flex items-center gap-3 rounded-full border border-slate-100 bg-slate-50 px-6 py-2.5 text-slate-400 transition-all dark:border-white/5 dark:bg-white/5 dark:hover:text-white"
              >
          ...
          <div className="group flex flex-col items-center space-y-10 text-center md:items-start md:text-left">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="font-sans max-w-xs text-[11px] font-medium tracking-[0.2em] text-balance text-slate-500 uppercase md:max-w-sm md:text-[13px] dark:text-slate-400">
                {bride.parents}
              </p>
              <a
